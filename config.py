...
# /start message ke saath jaane wali default image — env se override ho sakti
# hai, lekin agar owner ne kuch set nahi kiya to yeh Drive image use hogi.
# NOTE: Google Drive ka normal "view" link (…/file/d/ID/view) seedha image
# serve nahi karta (HTML page deta hai), isliye ID nikal kar
# "uc?export=view&id=ID" wale direct-serve format mein convert kiya gaya hai.
START_IMAGE_URL = os.getenv("START_IMAGE_URL") or (
    "https://drive.google.com/uc?export=view&id=14ycxeXt6avCum3uciahP2g2_FJtKuAvz"
)
